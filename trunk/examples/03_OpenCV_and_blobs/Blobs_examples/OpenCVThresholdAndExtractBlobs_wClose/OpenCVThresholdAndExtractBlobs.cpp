...
int main(int argc, char* argv[])
{
	...
	cvNamedWindow( "grayThresh before", 0 );
	cvShowImage( "grayThresh before", grayThresh );

	// Perform Morphological Ops (This is a "closing" operation)
	cvDilate(grayThresh,grayThresh, SE);
	cvNamedWindow( "grayThresh after dilate", 0 );
	cvShowImage( "grayThresh after dilate", grayThresh );
	
	cvErode(grayThresh,grayThresh, SE);
	cvNamedWindow( "grayThresh after erode closing", 0 );
	cvShowImage( "grayThresh after erode closing", grayThresh );
